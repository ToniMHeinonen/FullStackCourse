...
describe('total likes', () => {
  ...
  test('emptly blogs list should equal 0', () => {
...
describe('favorite blog', () => {
  ...
  test('list with identical blog post likes', () => {
...
describe('most blogs', () => {
  const listWithIdenticalBlogCount = [
    {
      _id: '5a422a851b54a676234d17f7',
      title: 'React patterns',
      author: 'Michael Chan',
  ...
  test('multiple blogs posts for one author', () => {
  ...
  test('identical blog count', () => {
    expect(listHelper.mostBlogs(listWithIdenticalBlogCount)).toEqual({
      author: 'Michael Chan',
      blogs: 1,
    })
  })
